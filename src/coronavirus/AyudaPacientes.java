 ...
 * @author apple
 */
public class AyudaPacientes extends javax.swing.JFrame {
...
void TablaFarmacias() {
    ...
    void TablaMedicamentos() {
        ...
        Object[] columnIdentifier = new Object[]{"Nombre del medicamento", "Cantidad", "Precio de datos"};               //aqui estoy haciuendo una estructura
        model.setColumnIdentifiers(columnIdentifier);
    ...
    private void initComponents() {
        ...
        btnRegresarMenu.setBounds(30, 570, 211, 29);
        ...
        btnSalir.setBounds(380, 570, 210, 29);
        ...
        tablasDeDatos.setBounds(0, 190, 630, 316);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/proyecto.png"))); // NOI18N
    ...
    private void btnRegresarMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarMenuActionPerformed
        InicioPrograma prm = new InicioPrograma();
        prm.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AyudaPacientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AyudaPacientes().setVisible(true);
            }
        });
    }
